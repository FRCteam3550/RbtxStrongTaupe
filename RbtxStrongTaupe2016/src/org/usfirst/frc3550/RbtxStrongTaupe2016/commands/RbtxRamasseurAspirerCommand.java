 ...
 *
 */
public class RbtxRamasseurAspirerCommand extends Command {
    ...
    public RbtxRamasseurAspirerCommand() {
    ...
    protected void execute() {
    	Robot.ramasseur.aspirerNormalementLeBallon();
    }

    // Make this return true when this Command no longer needs to run execute()
    protected boolean isFinished() {
          return Robot.ramasseur.hasBall();
    	//return false;
