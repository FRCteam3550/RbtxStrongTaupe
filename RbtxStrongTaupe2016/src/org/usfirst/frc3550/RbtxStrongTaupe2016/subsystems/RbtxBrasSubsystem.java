...
public class RbtxBrasSubsystem extends Subsystem {
    ...
    private final DigitalInput m_limitSwitchHaut = RobotMap.limitSwitchBrasHaut;
    private final DigitalInput m_limitSwitchBas = RobotMap.limitSwitchbrasBas;
    
    private static final double DIRECTIONHAUT = 1;
    private static final double DIRECTIONBAS = -1;
    private static final double VITESSEZERO = 0;
    private static final double VITESSEHAUT = 1;
    private static final double VITESSEBAS = -1;
    ...
    public void monter(){
    	m_moteur.set(DIRECTIONHAUT*VITESSEHAUT);
    }
    
    public void descendre(){
    	m_moteur.set(DIRECTIONBAS*VITESSEBAS);
    }
