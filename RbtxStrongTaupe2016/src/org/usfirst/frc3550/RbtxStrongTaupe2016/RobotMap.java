...
public class RobotMap {
    ...
    private static final double RADIUS_ROUES = 3.375;
    ...
    public static void init() {
        ...
        LiveWindow.addSensor("RbtxBrasSubsystem", "m_limitSwitchHaut", limitSwitchBrasHaut);
        
        limitSwitchBrasBas = new DigitalInput(1);
        LiveWindow.addSensor("RbtxBrasSubsystem", "m_limitSwitchBas", limitSwitchBrasBas);
        ...
        LiveWindow.addSensor("RbtxAccelerateurSubsystem", "m_limitSwitchDetectionBallon", limitSwitchDetectionBallon);
