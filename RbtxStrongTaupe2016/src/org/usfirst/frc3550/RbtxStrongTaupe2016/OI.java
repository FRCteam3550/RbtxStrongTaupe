...
public class OI {
	...
	public OI() {
		...
		SmartDashboard.putData("RbtxArcadeDrive", new RbtxArcadeDriveCommand());
		SmartDashboard.putData("RbtxComBrasBas", new RbtxBrasBasCommand());
		SmartDashboard.putData("RbtxComBrasHaut", new RbtxBrasHautCommand());
		SmartDashboard.putData("RbtxComLanceurActifmax", new RbtxLanceurCommand());
		SmartDashboard.putData("RbtxComRamasseurActif", new RbtxRamasseurCommand());
